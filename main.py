from src.utils.app_runner import process_exec, shutdown_handler, process_exec_thread
...
if __name__ == "__main__":
    ...
    try:
        if app == "sync":
            process_exec_thread(services=(http_srv, sync_core.service_sync))
        elif app == "dns":
            process_exec_thread(services=(http_srv, dns_core.dns_srv))
        else:
            logger.error(

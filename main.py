from src.utils.app_runner import shutdown_handler, thread_exec
...
if __name__ == "__main__":
    ...
    try:
        if app == "sync":
            thread_exec(services=(http_srv, sync_core.service_sync))
        elif app == "dns":
            thread_exec(services=(http_srv, dns_core.dns_srv))
        else:
            logger.error(
